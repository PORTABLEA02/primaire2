...
const ClassManagement: React.FC = () => {
  const classes = [
    { name: 'Maternelle 1A', level: 'Maternelle', students: 25, capacity: 30, teacher: 'Mme Kone' },
    { name: 'Maternelle 1B', level: 'Maternelle', students: 28, capacity: 30, teacher: 'Mme Diallo' },
    { name: 'CI A', level: 'CI', students: 32, capacity: 35, teacher: 'M. Traore' },
    { name: 'CP1', level: 'CP', students: 30, capacity: 35, teacher: 'Mlle Coulibaly' },
    { name: 'CP2', level: 'CP', students: 29, capacity: 35, teacher: 'M. Sangare' },
    { name: 'CE1A', level: 'CE1', students: 35, capacity: 40, teacher: 'Mme Toure' },
    { name: 'CE2B', level: 'CE2', students: 38, capacity: 40, teacher: 'M. Sidibe' },
    { name: 'CM2A', level: 'CM2', students: 42, capacity: 45, teacher: 'M. Ouattara' }
  ];
              ...
              {classes.map((classItem, index) => {
                ...
                return (
                  <tr key={index} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-gray-800">{classItem.teacher}</td>
